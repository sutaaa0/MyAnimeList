...
const Navbar = () => {
    ...
    return (
        <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full fixed bg-blend-saturation text-sm py-4 dark:bg-gray-800 bg-black blur-">
        <nav className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
          <div className="flex items-center justify-between">
            <a className="flex-none text-md lg:text-xl font-semibold dark:text-white p-2 rounded-lg bg-white text-black "  href="/"><span className="bg-black rounded-md text-white font-bold p-1">M</span>.A.List</a>
          ...
          <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block px-2">
            <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:bg-transparent rounded-md sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
              ...
              <a className="font-medium text-gray-600 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/topcharacter">Top Character</a>
            </div>
          </div>
        </nav>
      </header>
